...
" Last Updated: Fri Dec 25 08:57:34 2020
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if has('nvim')
    ...
    let g:terminal_color_12 = '#7f97af'
  ...
  hi Boolean guifg=#689d6a guibg=NONE gui=NONE cterm=NONE
  hi Float guifg=#d3869b guibg=NONE gui=NONE cterm=NONE
  hi Number guifg=#d3869b guibg=NONE gui=NONE cterm=NONE
  hi Character guifg=#b8bb26 guibg=NONE gui=NONE cterm=NONE
  hi String guifg=#b8bb26 guibg=NONE gui=NONE cterm=NONE
  hi Function guifg=#fabd2f guibg=NONE gui=NONE cterm=NONE
  hi Keyword guifg=#af7fb8 guibg=NONE gui=NONE cterm=NONE
  hi Conditional guifg=#98c8df guibg=NONE gui=NONE cterm=NONE
  hi Operator guifg=#98c8df guibg=NONE gui=NONE cterm=NONE
  hi StorageClass guifg=#7f97af guibg=NONE gui=NONE cterm=NONE
  hi Structure guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
  hi Type guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
  hi Delimiter guifg=#e9593d guibg=NONE gui=NONE cterm=NONE
  hi ColorColumn guifg=NONE guibg=#2d3031 gui=NONE cterm=NONE
  hi Conceal guifg=#7c6f64 guibg=NONE gui=NONE cterm=NONE
  hi Cursor guifg=#ebdbb2 guibg=#79740e gui=NONE cterm=NONE
  ...
  hi Directory guifg=#7f97af guibg=NONE gui=NONE cterm=NONE
  ...
  hi Title guifg=#fabd2f guibg=NONE gui=NONE cterm=NONE
  hi MatchParen guifg=NONE guibg=#076678 gui=NONE cterm=NONE
  hi IncSearch guifg=#fe8019 guibg=NONE gui=reverse cterm=reverse
  hi ModeMsg guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
  ...
  hi SpellBad guifg=#9d0006 guibg=NONE guisp=#9d0006 gui=NONE,undercurl cterm=NONE,underline
  hi SpellCap guifg=#076678 guibg=NONE guisp=#076678 gui=NONE,undercurl cterm=NONE,underline
  hi SpellLocal guifg=#79740e guibg=NONE guisp=#79740e gui=NONE,undercurl cterm=NONE,underline
  hi SpellRare guifg=#e9593d guibg=NONE guisp=#e9593d gui=NONE,undercurl cterm=NONE,underline
  hi Pmenu guifg=#928374 guibg=#3c3836 gui=NONE cterm=NONE
  hi PmenuSel guifg=#3c3836 guibg=#b8bb26 gui=NONE cterm=NONE
  ...
  hi WildMenu guifg=#689d6a guibg=#504945 gui=NONE cterm=NONE
  hi Comment guifg=#7c6f64 guibg=NONE gui=NONE cterm=NONE
  hi Constant guifg=#d3869b guibg=NONE gui=NONE cterm=NONE
  hi Error guifg=#e9593d guibg=#ebdbb2 gui=NONE,reverse cterm=NONE,reverse
  hi Identifier guifg=#7f97af guibg=NONE gui=NONE cterm=NONE
  hi PreProc guifg=#689d6a guibg=NONE gui=NONE cterm=NONE
  hi Special guifg=#e9593d guibg=NONE gui=NONE cterm=NONE
  hi SpecialComment guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
  hi SpecialChar guifg=#fabd2f guibg=NONE gui=NONE cterm=NONE
  hi Statement guifg=#af7fb8 guibg=NONE gui=NONE cterm=NONE
  hi Todo guifg=#928374 guibg=NONE gui=NONE cterm=NONE
  hi Ignore guifg=fg guibg=NONE gui=NONE cterm=NONE
  hi ToolbarLine guifg=NONE guibg=#076678 gui=NONE cterm=NONE
  hi ToolbarButton guifg=#928374 guibg=#504945 gui=NONE cterm=NONE
  ...
  hi netrwLex guifg=#689d6a guibg=NONE gui=NONE cterm=NONE
  hi netrwYacc guifg=#689d6a guibg=NONE gui=NONE cterm=NONE
  ...
  hi netrwDoc guifg=#7f97af guibg=NONE gui=NONE cterm=NONE
  hi! link BufTabLineCurrent PmenuSel
  hi! link BufTabLineActive TabLineSel
  hi! link BufTabLineHidden TabLine
  hi! link BufTabLineFill TabLineFill
  hi BufTabLineModifiedCurrent guifg=#3c3836 guibg=#b8bb26 gui=NONE cterm=NONE
  hi BufTabLineModifiedActive guifg=#b8bb26 guibg=#3c3836 gui=NONE cterm=NONE
  hi BufTabLineModifiedHidden guifg=#928374 guibg=#3c3836 gui=NONE cterm=NONE
  hi mkdCodeStart guifg=#79740e guibg=NONE gui=NONE cterm=NONE
  hi! link mkdCodeEnd mkdCodeStart
  hi mkdStrike guifg=#076678 guibg=NONE gui=NONE cterm=NONE
  hi! link mkdHeading mkdStrike
  hi mkdURL guifg=#7c6f64 guibg=NONE gui=NONE cterm=NONE
  hi! link mkdBlockquote mkdURL
  hi mkdDelimiter guifg=#7f97af guibg=NONE gui=NONE cterm=NONE
  hi mkdLineBreak guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  if !s:NONEs
    hi Boolean gui=NONE cterm=NONE
    hi Float gui=NONE cterm=NONE
    hi Number gui=NONE cterm=NONE
    hi Character gui=NONE cterm=NONE
    ...
    hi BufTabLineModifiedCurrent gui=NONE cterm=NONE
    hi BufTabLineModifiedActive gui=NONE cterm=NONE
    hi BufTabLineModifiedHidden gui=NONE cterm=NONE
    hi mkdCodeStart gui=NONE cterm=NONE
    hi mkdStrike gui=NONE cterm=NONE
  endif
  unlet s:t_Co s:NONEs
  finish
endif
...
if s:t_Co >= 256
  ...
  hi Float ctermfg=217 ctermbg=NONE cterm=NONE
  ...
  hi Conditional ctermfg=116 ctermbg=NONE cterm=NONE
  ...
  hi Cursor ctermfg=187 ctermbg=100 cterm=NONE
  ...
  hi MatchParen ctermfg=NONE ctermbg=25 cterm=NONE
  ...
  hi MoreMsg ctermfg=220 ctermbg=NONE cterm=NONE
  hi NonText ctermfg=239 ctermbg=NONE cterm=NONE
  hi Question ctermfg=208 ctermbg=NONE cterm=NONE
  hi SignColumn ctermfg=208 ctermbg=233 cterm=NONE
  hi SpecialKey ctermfg=25 ctermbg=NONE cterm=NONE
  hi SpellBad ctermfg=88 ctermbg=NONE cterm=NONE,underline
  hi SpellCap ctermfg=25 ctermbg=NONE cterm=NONE,underline
  hi SpellLocal ctermfg=100 ctermbg=NONE cterm=NONE,underline
  hi SpellRare ctermfg=202 ctermbg=NONE cterm=NONE,underline
  hi Pmenu ctermfg=245 ctermbg=237 cterm=NONE
  hi PmenuSel ctermfg=237 ctermbg=142 cterm=NONE
  ...
  hi WildMenu ctermfg=71 ctermbg=239 cterm=NONE
  hi Comment ctermfg=243 ctermbg=NONE cterm=NONE
  hi Constant ctermfg=217 ctermbg=NONE cterm=NONE
  hi Error ctermfg=202 ctermbg=187 cterm=NONE,reverse
  ...
  hi ToolbarButton ctermfg=245 ctermbg=239 cterm=NONE
  hi! link Typedef Type
  hi! link Define PreProc
  hi! link Include PreProc
  hi! link Exception Special
  ...
  hi! link netrwHdr PreProc
  hi netrwLex ctermfg=71 ctermbg=NONE cterm=NONE
  hi netrwYacc ctermfg=71 ctermbg=NONE cterm=NONE
  ...
  hi netrwDoc ctermfg=103 ctermbg=NONE cterm=NONE
  hi! link BufTabLineCurrent PmenuSel
  hi! link BufTabLineActive TabLineSel
  hi! link BufTabLineHidden TabLine
  hi! link BufTabLineFill TabLineFill
  hi BufTabLineModifiedCurrent ctermfg=237 ctermbg=142 cterm=NONE
  hi BufTabLineModifiedActive ctermfg=142 ctermbg=237 cterm=NONE
  hi BufTabLineModifiedHidden ctermfg=245 ctermbg=237 cterm=NONE
  hi mkdCodeStart ctermfg=100 ctermbg=NONE cterm=NONE
  hi! link mkdCodeEnd mkdCodeStart
  hi mkdStrike ctermfg=25 ctermbg=NONE cterm=NONE
  hi! link mkdHeading mkdStrike
  hi mkdURL ctermfg=243 ctermbg=NONE cterm=NONE
  hi! link mkdBlockquote mkdURL
  hi mkdDelimiter ctermfg=103 ctermbg=NONE cterm=NONE
  ...
  if !s:NONEs
    ...
    hi BufTabLineModifiedCurrent cterm=NONE
    hi BufTabLineModifiedActive cterm=NONE
