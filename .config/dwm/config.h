...
/* appearance */
static Gap default_gap  = {.isgap = 1, .realgap = 10, .gappx = 15};
...
static char *colors[][3]      = {
	/*                       fg    a fixed literal or a preprocessor macro.     bg         border   */
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_f,      togglefullscr,  {1} },
	...
	{ 0, XF86XK_AudioRaiseVolume,   spawn,        SHCMD("audio vol +5") },
	{ 0, XF86XK_AudioLowerVolume,   spawn,        SHCMD("audio vol -5") },
	{ MODKEY|ControlMask,   XK_p,   spawn,        SHCMD("scrot") },
};
